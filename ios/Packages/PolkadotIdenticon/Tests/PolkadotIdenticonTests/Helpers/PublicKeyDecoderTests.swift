...
final class PublicKeyDecoderTests: XCTestCase {
    ...
    func testDecodeData() {
        ...
        // When
        let result = publicKeyDecoder.keyAsData(dataPublicKey)
    ...
    func testDecodeHex() {
        ...
        // When
        let result = publicKeyDecoder.keyAsData(hexPublicKey)
    ...
    func testDecodeBase58() {
        ...
        // When
        let result = publicKeyDecoder.keyAsData(base58PublicKey)
