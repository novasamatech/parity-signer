        ...
        if data.canaryDead {
            ...
            .alert(isPresented: $alert, content: {
                Alert(
                    ...
                    message: Text("Signer detects currently connected network; please enable airplane mode and handle security breach"),
            ...
            if data.alert {
                ...
                .alert(isPresented: $alert, content: {
                    Alert(
                        title: Text("Network was detected!"),
                        message: Text("Network connection event was previously detected. Please follow your security protocol"),
