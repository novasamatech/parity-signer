...
RCT_EXTERN_METHOD(secureSubstrateSign:(NSString*)app key:(NSString*)key path:(NSString*)path password:(NSString*)password message:(NSString*)message encrypted:(NSString*)encrypted legacy:(BOOL)legacy resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject)
