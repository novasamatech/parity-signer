...
To learn more on key generation, read [subkey specifications](https://substrate.dev/docs/en/knowledgebase/integrate/subkey) that Signer follows tightly and [Signer key management](./docs/tutorials/Hierarchical-Deterministic-Key-Derivation.md).
...
Details on [signing with Pokadot.js Apps](./docs/tutorials/Kusama-tutorial.md)
