...
public class EthkeyBridge extends ReactContextBaseJavaModule {
    ...
    private static native String snSubstrateBrainwalletSign(Activity activity, String app, String key, String path, String password, String message, String encrypted, boolean legacy);
}
