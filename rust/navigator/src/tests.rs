...
*/    
    ...
    fn flow_test_1() {
        ...
        assert!(cut_real_json == expected_json, "NavbarSettings on Log screen. Expected Settings screen with no modals, got:\n{}", real_json);
        ...
        let cut_real_json = real_json
            .replace(EMPTY_PNG, r#"<empty>"#)
            .replace(ALICE_SR_SECRET_PATH_MULTIPASS, r#"<alice_sr25519_//secret//path///multipass>"#)
            .replace(ALICE_SR_POLKADOT, r#"<alice_sr25519_//polkadot>"#);
        ...
        assert!(cut_real_json == expected_json, "GoForward on DeriveKey screen with no modals. Expected updated Keys screen, got:\n{}", cut_real_json);
        ...
        assert!(cut_real_json == expected_json, "RightButton on Keys screen. Expected SeedMenu modal to appear, got:\n{}", real_json);
        ...
        assert!(cut_real_json == expected_json, "ChangeNetwork on Keys screen. Expected Keys screen for Alice westend keys, got:\n{}", real_json);
        ...
        let cut_real_json = real_json
            ...
            .replace(ALICE_SR_ALICE, r#"<alice_sr25519_//Alice>"#)
            .replace(ALICE_SR_ALICE_SECRET_SECRET, r#"<alice_sr25519_//Alice/secret//secret>"#)
        ...
        assert!(cut_real_json == expected_json, "Swipe on Keys screen for Alice westend keys. Expected updated Keys screen, got:\n{}", real_json);
        ...
        assert!(cut_real_json == expected_json, "RemoveKey on Keys screen with swiped key. Expected updated Keys screen, got:\n{}", real_json);
        ...
        assert!(cut_real_json == expected_json, "Increment on Keys screen with swiped key. Expected updated Keys screen, got:\n{}", real_json);
        ...
        assert!(cut_real_json == expected_json, "LongTap on Keys screen. Expected updated Keys screen, got:\n{}", real_json);
        ...
        assert!(cut_real_json == expected_json, "SelectKey on Keys screen in multiselect mode. Expected updated Keys screen, got:\n{}", cut_real_json);
        ...
        let cut_real_json = real_json
            ...
            .replace(ALICE_SR_WESTEND, r#"<alice_sr25519_//westend>"#);
        let expected_json = r#"{"screen":"Keys","screenLabel":"","back":true,"footer":true,"footerButton":"Keys","rightButton":"Backup","screenNameType":"h4","modal":"Empty","alert":"Empty","screenData":{"root":{"seed_name":"Alice","identicon":"<empty>","address_key":"","base58":"","swiped":false,"multiselect":false},"set":[{"address_key":"013efeca331d646d8a2986374bb3bb8d6e9e3cfcdd7c45c2b69104fab5d61d3f34","base58":"5DVJWniDyUja5xnG4t5i3Rrd2Gguf1fzxPYfgZBbKcvFqk4N","identicon":"<alice_sr25519_//westend>","has_pwd":false,"path":"//westend","swiped":false,"multiselect":false},{"address_key":"018266a693d6872d2b6437215c198ee25cabf2e4256df9ad00e979e84b00b5235e","base58":"5F1gaMEdLTzoYFV6hYqX9AnZYg4bknuYE5HcVXmnKi1eSCXK","identicon":"<alice_sr25519_//Alice/secret//secret>","has_pwd":false,"path":"//Alice/secret//secret","swiped":false,"multiselect":false},{"address_key":"01d43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d","base58":"5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY","identicon":"<alice_sr25519_//Alice>","has_pwd":false,"path":"//Alice","swiped":false,"multiselect":false}],"network":{"title":"Westend","logo":"westend"},"multiselect_mode":false,"multiselect_count":""},"modalData":{},"alertData":{}}"#;
        assert!(cut_real_json == expected_json, "GoBack on Keys screen with multiselect mode. Expected updated Keys screen, got:\n{}", real_json);
        ...
        let cut_real_json = real_json
            .replace(ALICE_WESTEND_ALICE_SECRET_SECRET_QR, r#"<alice_westend_//Alice/secret//secret_qr>"#)
            .replace(ALICE_SR_ALICE_SECRET_SECRET, r#"<alice_sr25519_//Alice/secret//secret>"#);
        ...
        let cut_real_json = cut_address_key(&cut_base58(&cut_identicon(&real_json.replace(EMPTY_PNG, r#"<empty>"#))));
        ...
        let cut_real_json = real_json
            .replace(BOB, r#"<bob>"#);
        let expected_json_transaction_sign = expected_json_transaction_sign.replace("5F1gaMEdLTzoYFV6hYqX9AnZYg4bknuYE5HcVXmnKi1eSCXK", &pepper_westend_base58).replace("<alice_sr25519_//Alice/secret//secret>", &pepper_westend_identicon).replace("//Alice/secret//secret", "//westend").replace("Alice", "Pepper");
        assert!(cut_real_json == expected_json_transaction_sign, "TransactionFetched on Scan screen containing transaction. Expected Transaction screen with no modals, got:\n{}", real_json);
        ...
        let cut_real_json = cut_real_json
            .replace(BOB, r#"<bob>"#);
        let expected_json_transaction_ready = expected_json_transaction_ready.replace("5F1gaMEdLTzoYFV6hYqX9AnZYg4bknuYE5HcVXmnKi1eSCXK", &pepper_westend_base58).replace("<alice_sr25519_//Alice/secret//secret>", &pepper_westend_identicon).replace("//Alice/secret//secret", "//westend").replace("Alice", "Pepper");
        assert!(cut_real_json == expected_json_transaction_ready, "GoForward on parsed transaction. Expected modal SignatureReady, got:\n{}", real_json);
