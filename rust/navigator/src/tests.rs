...
fn flow_test_1() {
    ...
    let cut_real_json = timeless(&real_json).replace(ALICE_SR_ALICE, r#"<alice_sr25519_//Alice>"#);
    ...
    let cut_real_json =
        cut_checksum(&timeless(&real_json)).replace(ALICE_SR_ALICE, r#"<alice_sr25519_//Alice>"#);
    ...
    assert!(
        cut_real_json == expected_json,
        "Shield on Log screen with no modal. Expected same Log screen with Shield alert, got:\n{}",
        real_json
    );
    ...
    assert!(
        cut_real_json == expected_json,
        "ViewGeneralVerifier on Settings screen. Expected Verifier screen with no modals, got:\n{}",
        real_json
    );
    ...
    assert!(
        real_json == expected_json,
        "NavbarKeys on Log screen. Expected SeedSelector screen with NewSeedMenu modal, got:\n{}",
        real_json
    );
    ...
    assert!(
        real_json == expected_json,
        "NewSeed on SeedSelector screen with NewSeedMenu modal. Expected NewSeed screen, got:\n{}",
        real_json
    );
    ...
    assert!(
        cut_real_json == expected_json,
        "SelectKey on Keys screen. Expected KeyDetails screen for Alice //polkadot key, got:\n{}",
        real_json
    );
    ...
    assert!(
        cut_real_json == expected_json,
        "NavbarKeys on Log screen. Expected updated SeedSelector screen with no modals, got:\n{}",
        real_json
    );
