...
mod tests {
    use hex;
    use transaction_parsing::{produce_output, produce_historic_output};
    ...
    fn sign_action_test (action_is_sign: bool, checksum_str: &str, seed_phrase: &str, pwd_entry: &str, user_comment: &str, dbname: &str) -> Result<String, ErrorSigner> {
        if action_is_sign {
            let checksum = checksum(checksum_str).unwrap();
...
// can sign a message
    ...
    fn can_sign_message_1() {
        ...
        let reply = produce_output(line, dbname);
        let reply_known_part = r#"{"author":[{"index":0,"indent":0,"type":"author","payload":{"base58":"5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY","identicon":"","seed":"Alice","derivation_path":"//Alice","has_password":false}}],"message":[{"index":1,"indent":0,"type":"text","payload":""},{"index":2,"indent":0,"type":"network_name","payload":"westend"}],"action":{"type":"sign","payload":""#;
        assert!(reply.contains(reply_known_part), "Error in action.\nReceived: {}", reply);
        let (action_is_sign, checksum_str) = get_type_and_checksum(&reply);
        let result = sign_action_test(action_is_sign, &checksum_str, SEED_PHRASE, PWD, USER_COMMENT, dbname);
        match result {
...
Identities: 
	...
	public_key: f606519cb8726753885cd4d0f518804a69a5e0badf36fee70feadd8044081730, encryption: sr25519, path: //polkadot, available_networks: 
        ...
        let reply = produce_output(&line, dbname);
        let reply_known_part = r#"{"author":[{"index":0,"indent":0,"type":"author","payload":{"base58":"5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY","identicon":"","seed":"Alice","derivation_path":"//Alice","has_password":false}}],"method":[{"index":1,"indent":0,"type":"pallet","payload":"Balances"},{"index":2,"indent":1,"type":"method","payload":{"method_name":"transfer_keep_alive","docs":""}},{"index":3,"indent":2,"type":"field_name","payload":{"name":"dest","docs_field_name":"","path_type":"sp_runtime >> multiaddress >> MultiAddress","docs_type":""}},{"index":4,"indent":3,"type":"enum_variant_name","payload":{"name":"Id","docs_enum_variant":""}},{"index":5,"indent":4,"type":"Id","payload":{"base58":"5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty","identicon":""}},{"index":6,"indent":2,"type":"field_name","payload":{"name":"value","docs_field_name":"","path_type":"","docs_type":""}},{"index":7,"indent":3,"type":"balance","payload":{"amount":"100.000000","units":"uWND"}}],"extensions":[{"index":8,"indent":0,"type":"era","payload":{"era":"Mortal","phase":"61","period":"64"}},{"index":9,"indent":0,"type":"nonce","payload":"261"},{"index":10,"indent":0,"type":"tip","payload":{"amount":"10.000000","units":"uWND"}},{"index":11,"indent":0,"type":"name_version","payload":{"name":"westend","version":"9111"}},{"index":12,"indent":0,"type":"tx_version","payload":"7"},{"index":13,"indent":0,"type":"block_hash","payload":"98a8ee9e389043cd8a9954b254d822d34138b9ae97d3b7f50dc6781b13df8d84"}],"action":{"type":"sign","payload":""#;
        assert!(reply.contains(reply_known_part), "Expected: {}...\nReceived: {}", reply_known_part, reply);
        let (action_is_sign, checksum_str) = get_type_and_checksum(&reply);
        sign_action_test(action_is_sign, &checksum_str, SEED_PHRASE, PWD, USER_COMMENT, dbname).unwrap();
    ...
    fn parse_transaction_alice_remarks_westend9122() {
        ...
        let reply = produce_output(&line.trim(), dbname);
        let reply_known_part = r#"{"warning":[{"index":0,"indent":0,"type":"warning","payload":"Received network information is not verified."}],"meta":[{"index":1,"indent":0,"type":"meta","payload":{"specname":"westend","spec_version":"9122","meta_hash":"d656951f4c58c9fdbe029be33b02a7095abc3007586656be7ff68fd0550d6ced"}}],"action":{"type":"stub","payload":""#;
        assert!(reply.contains(reply_known_part), "Expected: {}...\nReceived: {}", reply_known_part, reply);
        let (action_is_sign, checksum_str) = get_type_and_checksum(&reply);
        if action_is_sign {panic!("Should have been action `stub`.")}
        handle_stub(&checksum_str, dbname).unwrap();
        ...
        let reply = produce_output(line, dbname);
        let reply_known_part = r#"{"author":[{"index":0,"indent":0,"type":"author","payload":{"base58":"5DfhGyQdFobKM8NsWvEeAKk5EQQgYe9AydgJ7rMB6E1EqRzV","identicon":"","seed":"Alice","derivation_path":"","has_password":false}}],"method":[{"index":1,"indent":0,"type":"pallet","payload":"System"},{"index":2,"indent":1,"type":"method","payload":{"method_name":"remark","docs":"4d616b6520736f6d65206f6e2d636861696e2072656d61726b2e0a0a23203c7765696768743e0a2d20604f283129600a23203c2f7765696768743e"}},{"index":3,"indent":2,"type":"field_name","payload":{"name":"remark","docs_field_name":"","path_type":"","docs_type":""}},{"index":4,"indent":3,"type":"text","payload":""}],"extensions":[{"index":5,"indent":0,"type":"era","payload":{"era":"Mortal","phase":"36","period":"64"}},{"index":6,"indent":0,"type":"nonce","payload":"11"},{"index":7,"indent":0,"type":"tip","payload":{"amount":"0","units":"pWND"}},{"index":8,"indent":0,"type":"name_version","payload":{"name":"westend","version":"9122"}},{"index":9,"indent":0,"type":"tx_version","payload":"7"},{"index":10,"indent":0,"type":"block_hash","payload":"1b2b0a177ad4f3f93f9a56dae700e938a40201a5beabbda160a74c70e612c66a"}],"action":{"type":"sign","payload":""#;
        assert!(reply.contains(reply_known_part), "Expected: {}...\nReceived: {}", reply_known_part, reply);
        fs::remove_dir_all(dbname).unwrap();
    }
    ...
    fn proper_hold_display() {
        ...
        let line = fs::read_to_string("for_tests/add_specs_westend-ed25519_unverified.txt").unwrap();
        let reply = produce_output(&line.trim(), dbname);
        let (_, checksum_str) = get_type_and_checksum(&reply);
        handle_stub(&checksum_str, dbname).unwrap();
        let line = fs::read_to_string("for_tests/types_info_Alice.txt").unwrap();
        let reply = produce_output(&line.trim(), dbname);
