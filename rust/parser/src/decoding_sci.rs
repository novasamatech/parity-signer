...
fn decode_type_def_primitive (found_ty: &TypeDefPrimitive, possible_ext: &mut Option<&mut Ext>, compact_flag: bool, balance_flag: bool, data: &[u8], indent: u32, short_specs: &ShortSpecs) -> Result<DecodedOut, ParserError> {
    match found_ty {
        ...
        TypeDefPrimitive::U8 => decode_primitive_with_flags::<u8> (data, possible_ext, compact_flag, balance_flag, "u8", indent, short_specs),
        TypeDefPrimitive::U16 => decode_primitive_with_flags::<u16> (data, possible_ext, compact_flag, balance_flag, "u16", indent, short_specs),
        TypeDefPrimitive::U32 => decode_primitive_with_flags::<u32> (data, possible_ext, compact_flag, balance_flag, "u32", indent, short_specs),
        TypeDefPrimitive::U64 => decode_primitive_with_flags::<u64> (data, possible_ext, compact_flag, balance_flag, "u64", indent, short_specs),
        TypeDefPrimitive::U128 => decode_primitive_with_flags::<u128> (data, possible_ext, compact_flag, balance_flag, "u128", indent, short_specs),
...
pub (crate) fn decoding_sci_complete (current_type: &Type<PortableForm>, possible_ext: &mut Option<&mut Ext>, compact_flag: bool, balance_flag: bool, call_expectation: &CallExpectation, data: Vec<u8>, meta_v14: &RuntimeMetadataV14, indent: u32, short_specs: &ShortSpecs) -> Result<DecodedOut, ParserError> {
    ...
    let call_expectation = {
        if let SpecialType::Call = special_type {call_expectation.add()}
...
pub (crate) fn decoding_sci_entry_point (mut data: Vec<u8>, meta_v14: &RuntimeMetadataV14, mut indent: u32, short_specs: &ShortSpecs) -> Result<DecodedOut, ParserError> {
    ...
    let decoded_out = decoding_sci_complete(&current_type, &mut None, compact_flag, balance_flag, &CallExpectation::Pallet, data, meta_v14, indent, short_specs)?;
...
fn decode_type_def_sequence (inner_type: &Type<PortableForm>, possible_ext: &mut Option<&mut Ext>, balance_flag: bool, call_expectation: &CallExpectation, mut data: Vec<u8>, meta_v14: &RuntimeMetadataV14, indent: u32, short_specs: &ShortSpecs) -> Result<DecodedOut, ParserError> {
...
fn decode_type_def_array (inner_type: &Type<PortableForm>, len: u32, possible_ext: &mut Option<&mut Ext>, balance_flag: bool, mut data: Vec<u8>, meta_v14: &RuntimeMetadataV14, indent: u32, short_specs: &ShortSpecs) -> Result<DecodedOut, ParserError> {
...
fn decode_type_def_tuple (id_set: Vec<u32>, possible_ext: &mut Option<&mut Ext>, balance_flag: bool, mut data: Vec<u8>, meta_v14: &RuntimeMetadataV14, indent: u32, short_specs: &ShortSpecs) -> Result<DecodedOut, ParserError> {
    let mut fancy_out: Vec<OutputCard> = Vec::new();
...
fn decode_type_def_variant (found_ty: &TypeDefVariant<PortableForm>, possible_ext: &mut Option<&mut Ext>, call_expectation: &CallExpectation, mut data: Vec<u8>, meta_v14: &RuntimeMetadataV14, indent: u32, short_specs: &ShortSpecs) -> Result<DecodedOut, ParserError> {
    ...
    if check.is_option {
        ...
        let compact_flag = false;
        let balance_flag = false;
        let fields_processed = process_fields(found_variant.fields(), possible_ext, call_expectation, compact_flag, balance_flag, data, meta_v14, indent+1, short_specs)?;
...
fn decode_type_def_bit_sequence (bit_ty: &TypeDefBitSequence<PortableForm>, data: Vec<u8>, meta_v14: &RuntimeMetadataV14, indent: u32) -> Result<DecodedOut, ParserError> {
