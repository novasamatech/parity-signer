...
fn parse_transfer() {
    ...
    let call = hex::decode("040000e2e058da1316f8425be6c6f7104bb44c96fa29ea8b890b4c2866ba8bb6bc67b807007c118d35").unwrap();
...
fn parse_extensions() {
    ...
    let cards = decode_extensions(&mut &extension_data[..], &metadata).unwrap();

    println!("Extensions cards {:?}", cards);
}