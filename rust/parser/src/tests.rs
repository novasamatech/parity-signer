...
mod tests {
    ...
    fn specs() -> ShortSpecs {
        ShortSpecs {
            ...
            decimals: 12,
            genesis_hash: [
                225, 67, 242, 56, 3, 172, 80, 232, 246, 248, 230, 38, 149, 209, 206, 158, 78, 29,
                104, 170, 54, 193, 205, 44, 253, 21, 52, 2, 19, 243, 66, 62,
            ],
    ...
    fn tr_1() {
        ...
        let reply =
            parse_and_display_set(&data, &metadata("for_tests/westend9111"), &specs()).unwrap();
        let reply_known = r#"
Method:
...
block_hash: 5b1d91c89d3de85a4d6eee76ecf3a303cf38b59e7d81522eb7cd24b02eb161ff"#;
    ...
    fn tr_3() {
        ...
        let reply =
            parse_and_display_set(&data, &metadata("for_tests/westend9010"), &specs()).unwrap();
        let reply_known = "
Method:
...
block_hash: 98a8ee9e389043cd8a9954b254d822d34138b9ae97d3b7f50dc6781b13df8d84";
    ...
    fn tr_5() {
        ...
        let reply =
            parse_and_display_set(&data, &metadata("for_tests/westend9122"), &specs()).unwrap();
        let reply_known = "
Method:
...
block_hash: 1b2b0a177ad4f3f93f9a56dae700e938a40201a5beabbda160a74c70e612c66a";
    ...
    fn tr_6() {
        ...
        let specs_acala = ShortSpecs {
            ...
            decimals: 12,
            genesis_hash: [
                252, 65, 185, 189, 142, 248, 254, 83, 213, 140, 126, 166, 124, 121, 76, 126, 201,
                167, 61, 175, 5, 230, 213, 75, 20, 255, 99, 66, 201, 155, 166, 76,
            ],
