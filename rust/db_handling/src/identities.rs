...
pub fn generate_test_identities (database_name: &str) -> anyhow::Result<()> {
    let (identity_batch, events) = {
        ...
        let rococo_network_specs_key = NetworkSpecsKey::from_parts(&hex::decode("f6e9983c37baf68846fedafe21e56718790e39fb1c582abc408b81bc7b208f9a").expect("known value"), &Encryption::Sr25519);
