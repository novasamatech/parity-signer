...
struct CResultString* sn_substrate_brainwallet_sign(unsigned* error, const char* app, const char* key, const char* path, const char* password, const char* message, const char* encrypted, bool legacy);
