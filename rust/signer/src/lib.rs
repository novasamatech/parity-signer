...
export! {
	@Java_io_parity_signer_SubstrateSignModule_ethkeyBrainwalletAddress
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyBrainwalletBIP39Address
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyBrainwalletSign
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyRlpItem
	fn rlp_item(
		rlp: &str,
		position: u32
	) -> crate::Result<String> {
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyKeccak
	fn keccak256(
		data: &str
	) -> crate::Result<String> {
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyBlake
	fn blake(
		data: &str
	) -> crate::Result<String> {
		let data: Vec<u8> = data.from_hex()
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyBlockiesIcon
	fn blockies_icon(
		seed: String
	) -> crate::Result<String> {
		let mut result = Vec::new();
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyEthSign
	fn eth_sign(
		data: &str
	) -> crate::Result<String> {
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyRandomPhrase
	fn random_phrase(
		words_number:u32
	) -> String {
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyEncryptData
	fn encrypt_data(
		data: &str,
		password: String
	) -> crate::Result<String> {
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyDecryptData
	fn decrypt_data(
		data: &str,
		password: String
	) -> crate::Result<String> {
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyQrCodeHex
	fn qrcode_hex(
		data: &str
	) -> crate::Result<String> {
	...
	@Java_io_parity_signer_SubstrateSignModule_substrateBrainwalletAddress
	...
	@Java_io_parity_signer_SubstrateSignModule_substrateBrainwalletSign
	...
	@Java_io_parity_signer_SubstrateSignModule_schnorrkelVerify
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyDecryptDataRef
	fn decrypt_data_ref(
		data: &str,
		password: String
	) -> crate::Result<i64> {
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyDestroyDataRef
	fn destroy_data_ref(data_ref: i64) -> () {
		unsafe { Box::from_raw(data_ref as *mut String) };
	}

	@Java_io_parity_signer_SubstrateSignModule_ethkeyBrainwalletSignWithRef
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeySubstrateBrainwalletSignWithRef
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeySubstrateWalletAddressWithRef
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeyBrainWalletAddressWithRef
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeySubstrateMiniSecretKey
	...
	@Java_io_parity_signer_SubstrateSignModule_ethkeySubstrateMiniSecretKeyWithRef
