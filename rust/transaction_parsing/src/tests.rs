...
mod tests {
    ...
    fn parse_transaction_6_error_on_parsing() {
        ...
        let reply_known = r#""author":[{"index":0,"indent":0,"type":"author","payload":{"base58":"5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY","identicon":"<alice_sr25519_//Alice>","seed":"Alice","derivation_path":"//Alice","has_pwd":false}}],"error":[{"index":1,"indent":0,"type":"error","payload":"Error parsing incoming transaction. Metadata spec version matches. Error decoding transaction content. After decoding the method some data remained unused."}],"extensions":[{"index":2,"indent":0,"type":"era","payload":{"era":"Mortal","phase":"27","period":"64"}},{"index":3,"indent":0,"type":"nonce","payload":"46"},{"index":4,"indent":0,"type":"tip","payload":{"amount":"0","units":"pWND"}},{"index":5,"indent":0,"type":"name_version","payload":{"name":"westend","version":"9010"}},{"index":6,"indent":0,"type":"tx_version","payload":"5"},{"index":7,"indent":0,"type":"block_hash","payload":"538a7d7a0ac17eb6dd004578cb8e238c384a10f57c999a3fa1200409cd9b3f33"}]"#;
        let output = produce_output(line, dbname);
        if let Action::Read(reply) = output {
            let reply_cut = reply.replace(ALICE_SR_ALICE, r#"<alice_sr25519_//Alice>"#);
            assert!(reply_cut == reply_known, "Received: \n{}", reply);
    ...
    fn parse_transaction_8_error_on_parsing() {
        ...
        let reply_known = r#""author":[{"index":0,"indent":0,"type":"author","payload":{"base58":"5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY","identicon":"<alice_sr25519_//Alice>","seed":"Alice","derivation_path":"//Alice","has_pwd":false}}],"error":[{"index":1,"indent":0,"type":"error","payload":"Error parsing incoming transaction. Metadata spec version matches. Error decoding transaction content. Data too short for expected content."}],"extensions":[{"index":2,"indent":0,"type":"era","payload":{"era":"Mortal","phase":"27","period":"64"}},{"index":3,"indent":0,"type":"nonce","payload":"46"},{"index":4,"indent":0,"type":"tip","payload":{"amount":"0","units":"pWND"}},{"index":5,"indent":0,"type":"name_version","payload":{"name":"westend","version":"9010"}},{"index":6,"indent":0,"type":"tx_version","payload":"5"},{"index":7,"indent":0,"type":"block_hash","payload":"538a7d7a0ac17eb6dd004578cb8e238c384a10f57c999a3fa1200409cd9b3f33"}]"#;
        let output = produce_output(line, dbname);
        if let Action::Read(reply) = output {
            let reply_cut = reply.replace(ALICE_SR_ALICE, r#"<alice_sr25519_//Alice>"#);
            assert!(reply_cut == reply_known, "Received: \n{}", reply);
