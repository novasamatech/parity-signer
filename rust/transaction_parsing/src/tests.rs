...
mod tests {
    ...
    fn parse_transaction_3() {
        ...
        let reply = produce_output(line, dbname);
        let reply_known_part = r#"{"author":[{"index":0,"indent":0,"type":"author","payload":{"base58":"5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY","seed":"Alice","derivation_path":"//Alice","has_password":false,"name":"Alice_test_westend"}}],"method":[{"index":1,"indent":0,"type":"pallet","payload":"Balances"},{"index":2,"indent":1,"type":"method","payload":{"method_name":"transfer_keep_alive","docs":""}},{"index":3,"indent":2,"type":"varname","payload":"dest"},{"index":4,"indent":3,"type":"enum_variant_name","payload":{"name":"Id","docs_enum_variant":""}},{"index":5,"indent":4,"type":"Id","payload":"5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty"},{"index":6,"indent":2,"type":"varname","payload":"value"},{"index":7,"indent":3,"type":"balance","payload":{"amount":"300.000000000000","units":"WND"}}],"extrinsics":[{"index":8,"indent":0,"type":"era_mortal_nonce","payload":{"era":"Mortal","phase":"55","period":"64","nonce":"89"}},{"index":9,"indent":0,"type":"tip","payload":{"amount":"300.000000000000","units":"WND"}},{"index":10,"indent":0,"type":"block_hash","payload":"a8dfb73a4b44e6bf84affe258954c12db1fe8e8cf00b965df2af2f49c1ec11cd"},{"index":11,"indent":0,"type":"tx_spec","payload":{"network":"westend","version":"9010","tx_version":"5"}}],"action":{"type":"sign","payload":""#;
        assert!(reply.contains(reply_known_part), "Expected: {}...\nReceived: {}", reply_known_part, reply);
        fs::remove_dir_all(dbname).unwrap();
    }
