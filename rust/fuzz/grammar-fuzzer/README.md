...
This is a fork of [merkelized-metadata](https://github.com/bkchr/merkleized-metadata] which uses  [autarkie](https://github.com/R9295/autarkie) to create a grammar-fuzzer for fuzzing ``decode-call``.
